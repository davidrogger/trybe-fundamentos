...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {    
    ...
    expect(createMenu({ game: {}, movie: {} }).fetchMenu()).toEqual({ game: {}, movie: {} })
    expect(typeof createMenu({ game: {}, movie: {} }).fetchMenu()).toBe('object')
    // --------------------------------------------------------------------------------------
    ...
    expect(Array.isArray(createMenu({ food: {}, drink: {} }).consumption)).toBe(true);
    // ```
    ...
    expect(teste5.consumption).toContain('coxinha');    
    ...
    // ```
    const teste8 = createMenu({ food: { coxinha: 3.90, sanduiche: 9.90 }, drink: { agua: 3.90, cerveja: 6.90 } });
    teste8.order('coxinha');
    teste8.order('agua');
    teste8.order('coxinha');
    expect(teste8.pay()).toBe(11.7);
